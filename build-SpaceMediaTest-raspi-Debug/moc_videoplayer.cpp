...
#include "../src/widgets/videoplayer.h"
...
const QMetaObject VideoPlayer::staticMetaObject = {
    { &QVideoWidget::staticMetaObject, qt_meta_stringdata_VideoPlayer.data,
...
void *VideoPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SoundWidgetInfo"))
        return static_cast< SoundWidgetInfo*>(const_cast< VideoPlayer*>(this));
